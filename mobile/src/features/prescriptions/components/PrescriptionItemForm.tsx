...
const UNITY_OPTIONS = Object.values(UnityType).map((value) => ({
  value,
  label: UnityTypeLabels[value],
}));
const TREATMENT_OPTIONS = Object.values(TreatmentType).map((value) => ({
  value,
  label: TreatmentTypeLabels[value],
}));
...
export function PrescriptionItemForm({
  ...
  function handleSave(): void {
    ...
    if (!payload) {
      setError(
        "Preencha nome, dosagem e valores válidos (maiores que zero) para quantidade e dias.",
      );
      return;
    }
          ...
          <View style={styles.row}>
            <View style={[styles.field, styles.rowField]}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  updateForm({ prescribedQuantity: text.replace(/\D/g, "") })
                }
            ...
            <View style={[styles.field, styles.rowField]}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  updateForm({ treatmentDays: text.replace(/\D/g, "") })
                }
                keyboardType="number-pad"
